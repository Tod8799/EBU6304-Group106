...
/**
 * DAO for audit logs stored in `data/logs.csv`.
 */
public class AuditLogDAO {
    ...
    /**
     * Append a new audit log entry (appends to CSV).
     *
     * @param log the audit log entry to append
     */
    ...
    /**
     * Read all audit logs from storage.
     *
     * @return list of audit log entries (may be empty)
     */
